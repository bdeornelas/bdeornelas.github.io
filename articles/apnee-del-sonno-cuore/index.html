...
---
      ...
      <nav class="text-sm text-slate-400 mb-8" data-aos="fade-up">
        ...
        <span class="mx-2">/</span>
        <span class="text-white">Apnee notturne</span>
      </nav>
      ...
      <header class="mb-12" data-aos="fade-up">
        <div class="glass-card rounded-xl p-8 md:p-12">
          ...
          <h1 class="text-4xl md:text-5xl font-bold tracking-tight mb-6">
            <span class="gradient-text">Apnee Notturne:</span><br>
            <span class="text-white">quando russare è un campanello d'allarme per il cuore</span>
          </h1>
          <!-- Intro empatica -->
          <p class="text-xl text-slate-300 leading-relaxed mb-8">
            Durante la notte, mentre si dorme, le vie respiratorie possono chiudersi ripetutamente, causando pause nel respiro che interrompono il sonno e affaticano il cuore. Questo disturbo, spesso sottovalutato, aumenta il rischio di pressione alta, aritmie e altri problemi cardiovascolari. Riconoscere i sintomi e intervenire con le cure appropriate può migliorare drasticamente la qualità della vita e proteggere la salute del cuore.
          </p>
          <!-- Metadati -->
          <div class="flex flex-wrap gap-4 text-sm text-slate-400">
            ...
            <div class="flex items-center gap-2">
              ...
              Apnee, Russamento, Cuore, Pressione alta, CPAP
            </div>
          </div>
        </div>
      </header>
      ...
      <article class="glass-card rounded-xl p-8 md:p-12 mb-12" data-aos="fade-up" data-aos-delay="200">
        ...
        <!-- Sezione 1: Cosa sono le apnee notturne -->
        <section class="mb-12">
        ...
        <!-- Sezione 2: Sintomi da riconoscere -->
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
        ...
        <!-- Sezione 3: Perché le apnee sono pericolose -->
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
        ...
        <!-- Sezione 5: Come si diagnosticano -->
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
        ...
        <!-- Sezione 7: CPAP cosa aspettarsi -->
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
        ...
        <!-- Sezione 8: Consigli pratici e stile di vita -->
        <section class="mb-12">
          <h2 class="text-2xl font-bold mb-6 flex items-center gap-2">
